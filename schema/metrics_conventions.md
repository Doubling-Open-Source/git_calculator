...
| **Week bucket** | `commits_export.period_week` / `week_monday_unix`: ISO `YYYY-Www` and Monday 00:00 local (unix), exporter-populated to match legacy `isocalendar` ([ADR 0006](../docs/adr/0006-metrics-throughput-per-active-developer-weekly.md)). |
