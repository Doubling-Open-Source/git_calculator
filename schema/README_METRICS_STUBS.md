...
`metrics_cycle_time_monthly`, `metrics_cycle_time_delta_events`, `metrics_change_failure_monthly`, `metrics_throughput_monthly`, `metrics_active_developers_monthly`, `metrics_throughput_per_active_developer_weekly`, `metrics_throughput_per_active_developer_monthly` ([0007](../docs/adr/0007-metrics-throughput-per-active-developer-monthly.md)).
